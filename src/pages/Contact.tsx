        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-12">
          <div className="md:w-1/3">
            ...
            <div className="flex space-x-4">
              <a href="https://instagram.com" className="text-blueprint-blue hover:text-blue-800" aria-label="Instagram">
              ...
              <a href="https://github.com" className="text-blueprint-blue hover:text-blue-800" aria-label="GitHub">
              ...
              <a href="https://medium.com" className="text-blueprint-blue hover:text-blue-800" aria-label="Medium">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor"><path d="M7 6A7 7 0 0 0 7 20 7 7 0 0 0 7 6zM18.5 7A4.5 4.5 0 0 0 18.5 16 4.5 4.5 0 0 0 18.5 7zM22 8.5A2.5 2.5 0 0 0 22 13.5 2.5 2.5 0 0 0 22 8.5z"/></svg>
              </a>
              <a href="https://linkedin.com" className="text-blueprint-blue hover:text-blue-800" aria-label="LinkedIn">
